    ...
    <nav className='relative container mx-auto p-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='hidden space-x-6 md:flex'>
          <Link to='/blood-donor' className='hover:text-darkGrayishBlue'>
            Donate Blood
          </Link>
          <Link to='/blood-receiver' className='hover:text-darkGrayishBlue'>
            Request Blood
          </Link>
          <Link to='/blood-service' className='hover:text-darkGrayishBlue'>
            Blood-Services
          </Link>
          {/* {isUserLoggedIn() && ( */}
          <>
